...
class BlogPostContext(ContentContext):
    ...
    content_type: ContentType = Field(default=ContentType.BLOG_POST, description="Content type")
...
class TranscriptContext(ContentContext):
    ...
    content_type: ContentType = Field(default=ContentType.TRANSCRIPT, description="Content type")
...
class ReleaseNotesContext(ContentContext):
    ...
    content_type: ContentType = Field(default=ContentType.RELEASE_NOTES, description="Content type")
